...
id = robotino_node.getField('name')
print(id.getSFString())
...
robot_control = RLVBVP3(pos=position[:-1],comms_radius=6.0,reading_radius=3.0,resolution=540)
print()
